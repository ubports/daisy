...
# requeue core files that are in swift or if they do not exist in the crash
...
# TODO: could just have this code list the queue from swift check to see if
# the cores are older than 7 days and only requeue those crashes.
if len(sys.argv) < 2:
